...
const Contracter = () => {
    ...
    const markpresentabsentone = async (e, PM_id, attdate) => {
        ...
        const attstatus = text
        const attvalue = ide
        console.log(Time_In, Time_out, text, ide);
                        ...
                        <ul style={{ marginRight: "5%" }} class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <Tooltip title="Current Status of a day" variant="solid">
                                    <NavLink data-bs-toggle="modal" data-bs-target="#exampleModalone" onClick={() => { getallmemberstatus(); setOpen('center') }} type='button'
                                        className="btn btn-outline-light me-3 mb-1">Today's Status</NavLink>
                                </Tooltip>
